...
// const sum = ((...param) => param.reduce((acc, crr) => acc + crr, 0))
...
// function filterPeople(item) {
//   return item.filter(({ bornIn, nationality })=> bornIn < 2000 && nationality === 'Australian')
// }
...
const greet = (namae, greeting = 'Hi') => `${greeting} ${namae}`
