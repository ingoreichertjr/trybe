...
devido a ameaça de criaturas (chorizo) temíveis, o grupo não chegará inteiro ao fim.
...
describe('quem sobreviveu?', () => {
  ...
  afterAll(() => {
    const surv = adventure.specialists[0];
    console.log(`And in the end, only ${surv.nome}, the ${surv.classe} remained...`);
  });
